document.addEventListener("DOMContentLoaded", () => {
    ...
    const reviewWrappers = document.querySelectorAll("#reviews .cs-wrapper");

    // Get navigation buttons (existing ones in your HTML)
    const prevButton = document.querySelector("#reviews .cs-button-group .cs-button:first-child");
    const nextButton = document.querySelector("#reviews .cs-button-group .cs-button:last-child");
